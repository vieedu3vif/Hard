...
const JWT_TOKEN =
  "eyJhbGciOiJIUzUxMiJ9..fpAoudKBxKs2oDeXf_qwH407PdlUHULzsPTtmSvJthgZlJugWfRqJQqGRemoDd-00NfNoQLz6pBShChwrEwMxA";
...
async function fetchTelemetryData(deviceId) {
  ...
  try {
    ...
    console.error(
      `Error fetching telemetry data for device ${deviceId}:`,
      error
    );
  }
  return null;
...
app.get("/check-telemetry", async (req, res) => {
  try {
    ...
    res.status(200).send("Telemetry checked and notifications sent if needed.");
  } catch (error) {
